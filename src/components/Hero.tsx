      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          <div className="mb-8 relative">
            <div className="w-32 h-32 mx-auto rounded-full bg-gradient-to-r from-blue-600 to-teal-600 p-1 mb-6">
              <div className="w-full h-full rounded-full bg-slate-800 p-6 flex items-center justify-center">
                <img
                  src={profileImage}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16">
            <div className="flex space-x-4">
              <a
                ...
                className="p-3 bg-slate-800/50 hover:bg-slate-700 rounded-full border border-slate-700 hover:border-slate-600 transition-all duration-300 hover:scale-110"
              >
            ...
            <button className="flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-teal-600 hover:from-blue-700 hover:to-teal-700 text-white px-6 py-3 rounded-full font-medium transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-600/25" onClick={handleResumeClick}>
